...
#Step 3
#Have the items you are ordering al
Price = 0
for i in listOfOrders:
 message = str(input("would you like to buy a" ". Yes / No   ")
if myOrder == str(input(message))
myOrder == Yes and i = 1:
  ...
  if myOrder == "Yes" and i = 2:
    number = input("How many would you like? ")
    For a in range(number):
      price += 5.2so output their indavidual cost.
#Example
# "Coffee x 0 : 0.00"
# "Cake x 2 : 5.00"
# "Tea x 3 : 3.6"
